...
BIG_DIR_INPUT = f"{os.getcwd()}/IOT_2022_pxp"
BIG_DIR_OUTPUT = f"{os.getcwd()}/big_output"
BIG_A_FILE = f"{os.getcwd()}/IOT_2022_pxp/A.txt"
BIG_S_FILE = f"{os.getcwd()}/IOT_2022_pxp/satellite/S.txt"
